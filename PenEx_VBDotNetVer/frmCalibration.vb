...
Public Class frmCalibration
    ...
    Public m_MarkerDirect As Integer
                            ...
                            Case PenCalibrationSatus.CAL_BOTTOM
                                ...
                                If ret = True Then
                                    ...
                                    Else
                                        ...
                                        If m_LeftRight = 0 Then
                                            SetSMPosition(StationPosition.LEFT, True)
                                        Else
                                            SetSMPosition(StationPosition.RIGHT, True)
                                        End If
                                        SetCalibration_Top(m_CaliTop.X, m_CaliTop.Y)
                                        SetCalibration_Bottom(m_CaliBottom.X, m_CaliBottom.Y)
                                        SetCalibration_End()
                                        SaveCalibrationToDevice(m_CaliTop.X, m_CaliTop.Y, m_CaliTop.X, m_CaliBottom.Y, m_CaliBottom.X, m_CaliBottom.Y, m_CaliBottom.X, m_CaliTop.Y)
                                        SetCalibMode(False, True)
    ...
    Private Sub frmCalibration_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        m_MarkerDirect = CURRENT_MARKER_DIRECT
         LoadToolTip()
        ChangeCaliImg()
        If EquilModelCode = 5 Then SetCalibMode(True, True)
    End Sub
    ...
    Sub ChangeCaliImg()
        ...
        ElseIf EquilModelCode = 4 Or EquilModelCode = 5 Then
            Select Case m_MarkerDirect
